...
<p align="left">
  <a href="https://skillicons.dev">
    <img src="https://skillicons.dev/icons?i=c,cpp,java,py,js,ts,react,vite,html,css,tailwind,go,php,postgres,mysql,mongodb,fastapi,docker,linux,ubuntu,gcp,git,gitlab,githubactions,vercel,vscode,bash,ai,nodejs,npm,opencv,powershell,linkedin" alt="My Skills" />
  </a>
  <br />
